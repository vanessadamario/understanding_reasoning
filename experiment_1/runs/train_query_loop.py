...
def train_query_loop(opt, train_loader, val_loader, load=False):  # TODO: include
    ...
    if opt.method_type in ['SHNMN']:
        execution_engine, load_last = get_execution_engine(**kkwargs_exec_engine_)
