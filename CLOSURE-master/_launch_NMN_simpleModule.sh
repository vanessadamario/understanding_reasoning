...
#SBATCH --array=0,3
#SBATCH -c 1
#SBATCH --job-name=CoGenT_T_no_film
#SBATCH --mem=8GB
#SBATCH --gres=gpu:1
...
--batch_size 128 \
--allow_resume True \
--checkpoint_path path_to_folder/understanding_reasoning/CLOSURE-master/results/CoGenT/simpleModule_noFiLM_${SLURM_ARRAY_TASK_ID} \
