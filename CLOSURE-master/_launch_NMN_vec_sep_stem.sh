...
--batch_size 128 \
--allow_resume True \
--checkpoint_path /om2/user/vanessad/understanding_reasoning/CLOSURE-master/results/CoGenT/vector_sep_stem_${SLURM_ARRAY_TASK_ID} \
