...
import random, math
import runs.programs
from runs.programs import ProgramConverter
...
class ClevrDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        """
        if q_type is None:
            return feats, question, answer
            # (question, image, feats, answer, program_seq, program_json)
        return feats, [question, q_type], answer
        #  ([question, q_type], image, feats, answer, program_seq, program_json)
...
def clevr_collate(batch):
    ...
    return [feat_batch, question_batch, answer_batch]
