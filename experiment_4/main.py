...
output_path = {
    ...
    'om2': '/om2/user/vanessad/understanding_reasoning/experiment_4',
...
def generate_data(id):
    ...
    if FLAGS.relations:
        if FLAGS.attribute_comparison:
            ...
            DG = DataGenerator(PATH_MNIST_SPLIT, variety=FLAGS.variety, image_size=64)
            os.makedirs(join(output_data_folder, FLAGS.dataset_name), exist_ok=True)
            DG.generate_data_matrix(savepath=join(output_data_folder, FLAGS.dataset_name))
