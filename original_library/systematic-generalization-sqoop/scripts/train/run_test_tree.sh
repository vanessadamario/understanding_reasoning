...
do
  singularity exec -B /om:/om --nv /om/user/xboix/singularity/xboix-tensorflow-latest-tqm.simg \
    python /om/user/vanessad/om/user/vanessad/original_library/systematic-generalization-sqoop/scripts/run_model.py \
    --execution_engine $value \
    --program_generator $value \ 
    --vocab_json /om/user/vanessad/om/user/vanessad/compositionality/sqoop-variety_1-repeats_30000/vocab.json \ 
